import { Option, None, Result, Some } from "@bodil/opt";
import * as OS from "node:os";
import * as OSPath from "path";
import * as vscode from "vscode";
import { QuickInputButton, ThemeIcon, FileType, Uri, ViewColumn } from "vscode";
import { action, Action } from "./action";
import { ConfigItem, config } from "./ConfigItem";
...
export class FileBrowser {
    ...
    private static activeInstance: Option<FileBrowser> = None;

    static getInstance() {
        return FileBrowser.activeInstance;
    }

    static createInstance(path: Path, file: Option<string>) {
        FileBrowser.activeInstance = Some(new FileBrowser(path, file));
    }
    ...
    dispose() {
        ...
        FileBrowser.activeInstance = None;
    }
